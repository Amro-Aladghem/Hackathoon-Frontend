...
export function Main() {
  ...
  return (
    <>
      <section
        style={{ direction: "rtl" }}
        className="px-2 py-16 bg-white md:px-0 rtl"
      >
              ...
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                  ...
                  <span className="block text-indigo-600 xl:inline">
                    تساعدك على بناء نجاحك
                  </span>
                </h1>
                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  نرسم طريق النجاح لجميع الطلاب بتغيير طريقة التعلم المدعم
                  بالذكاء الأصطناعي
                </p>
      ...
      <div id="our-service-logo">
        ...
        <h2 className="text-4xl font-extrabold tracking-tight text-indigo-600 sm:text-5xl md:text-4xl lg:text-5xl xl:text-4xl">
          أدواتنا المميزة
        </h2>
      </div>
          ...
          <div className="flex flex-wrap items-center sm:-mx-3">
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  لا داعي لترهق نفسك وتضيع وقتك في التخطيط ,حمل ملفك الدراسي
      ...
      <div className="w-full py-4">
        <div className="w-full h-auto overflow-hidden flex items-center justify-center">
          <img
            src="/BotsImage.png"
            className="w-250 py-4 h-auto rounded-2xl shadow-indigo-600/50 drop-shadow-[0_0_15px_rgba(67,56,202,0.5)]"
          />
        </div>
      </div>

      <div
        className="flex space-x-4 justify-around my-16"
        style={{ direction: "rtl" }}
      >
        {/* card 1 */}
        <div
          ...
          <div className="px-6 py-6 md:px-12 lg:flex lg:items-center lg:px-16">
            <div className="lg:flex-1 xl:w-0">
              ...
              <p className="mt-3 max-w-3xl text-lg leading-6 text-indigo-200">
                اشترك في النشرة البريدية لكي تصلك كل التحديثات
              </p>
            </div>
            <div className="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
              <form className="sm:flex" id="revue-form" target="_blank">
                <input
                  ...
                  autoComplete="email"
                  required=""
                  className="w-full rounded-md bg-white border-white px-5 py-3 placeholder-gray-500 focus:outline-none focus:ring-0"
