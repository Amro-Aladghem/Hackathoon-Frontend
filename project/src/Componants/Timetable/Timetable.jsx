...
const Timetable = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(import.meta.env.VITE_TABLE_TIME_API, {
        method: "POST",
        body: formData,
      });
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <label className="group relative cursor-pointer">
              ...
              <div
                className={`relative h-32 transition-all duration-300 ${
                  isUploading
              ...
              >
                <div
                  className={`absolute inset-0 flex items-center justify-center rounded-xl border-2 border-dashed ${
                    uploadedFile
        ...
        <div className="grid md:grid-cols-3 gap-4 text-center">
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">
              تحويل ذكي باستخدام أحدث نماذج الذكاء الاصطناعي
            </p>
          </div>
          ...
          <div className="p-4 bg-purple-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">
              جميع الملفات محذوفة تلقائياً بعد التحويل
            </p>
          </div>
          ...
          <div className="p-4 bg-green-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">
              معالجة الملفات خلال ثوانٍ معدودة
            </p>
          </div>
        </div>
      </div>
